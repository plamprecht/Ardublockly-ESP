...
Blockly.Blocks['text_compare'] = {
  init: function() {
    this.appendValueInput("string_a")
        .setCheck(null)
        .appendField("texts");
    this.appendValueInput("string_b")
        .setCheck(null)
        .appendField("and");
    this.appendDummyInput()
        .appendField("are")
        .appendField(new Blockly.FieldDropdown([["identical","== 0"], ["not identical","!= 0"]]), "comparison");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("Compares two strings and returns bolean values (true / false)");
 this.setHelpUrl("https://www.tutorialspoint.com/c_standard_library/c_function_strcmp.htm");
  }
};

Blockly.Blocks['text_cut_delimiter'] = {
  init: function() {
    this.appendValueInput("string")
        .setCheck(null)
        .appendField("Cut text");
    this.appendValueInput("delimiters")
        .setCheck(null)
        .appendField("by delimiter(s)");
    this.appendDummyInput()
        .appendField("Initializing and delivering first part");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("Cuts a string by a delimiter - ATTENTION original string will be overwritten (copy with \"append text\" block before if needed!) - delivers the FIRST part till delimiter. For further parts use Block \"Cut text - return next part\"");
 this.setHelpUrl("https://www.tutorialspoint.com/c_standard_library/c_function_strtok.htm");
  }
};

Blockly.Blocks['text_cut_delimiter_next'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Cut text - delivering next part")
        .appendField("(empty after last part)");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("Cuts a string by one or more delimiter(s) - delivers next part of string and is empty as soon as all parts are delivered");
 this.setHelpUrl("https://www.tutorialspoint.com/c_standard_library/c_function_strtok.htm");
  }
};
