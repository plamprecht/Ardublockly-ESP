...
Blockly.Arduino['start_wlan_access_point'] = function(block) {
  ...
  var statements_while_wlan_connected = Blockly.Arduino.statementToCode(block, 'while_wlan_connected');
  ...
  var Code_AP_Stop = "Wifi.Disconnect();\n";
  ...
  Blockly.Arduino.addInclude('wifi', '#include <WiFi.h>');
  var code = Code_Comm_Prep + Code_Connect + Code_AP_Est + statements_while_wlan_connected + Code_AP_Stop;
  return code;
};
