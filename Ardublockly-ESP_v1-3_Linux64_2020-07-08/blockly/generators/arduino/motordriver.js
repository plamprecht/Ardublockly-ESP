...
Blockly.Arduino['l298n_setup'] = function(block) {
  ...
  var pwm_channel_a = block.getFieldValue('pwm_channel_a');
  var freq_a = block.getFieldValue('freq_a');
  var resolution_a = block.getFieldValue('resolution_a');
  var pwm_channel_b = block.getFieldValue('pwm_channel_b');
  var freq_b = block.getFieldValue('freq_b');
  var resolution_b = block.getFieldValue('resolution_b');
  ...
  //Configure PWM Motor A
  var max_speed_pwm_a = Math.pow(2, parseInt(resolution_a,10))-1;
  var setupCode_pwm_motor_a = "ledcSetup(" + pwm_channel_a + ", " + freq_a + ", "+ resolution_a + ");\n  ";
  setupCode_pwm_motor_a += "ledcWrite(" + pwm_channel_a + ", " + max_speed_pwm_a + ");";
  var setupCode_pwm_attach_a = "ledcAttachPin(PIN_MotorA_enA, " + pwm_channel_a + ");";
  Blockly.Arduino.addSetup("pwm_setup_" + pwm_channel_a, setupCode_pwm_motor_a, true);
  Blockly.Arduino.addSetup("pwm_attach_" + MotorA_enA, setupCode_pwm_attach_a, true);
  ...
  //Configure PWM Motor B
  var max_speed_pwm_b = Math.pow(2, parseInt(resolution_b,10))-1;
  var setupCode_pwm_motor_b = "ledcSetup(" + pwm_channel_b + ", " + freq_b + ", "+ resolution_b + ");\n  ";
  setupCode_pwm_motor_b += "ledcWrite(" + pwm_channel_b + ", " + max_speed_pwm_b + ");";
  var setupCode_pwm_attach_b = "ledcAttachPin(PIN_MotorB_enB, " + pwm_channel_b + ");";
  Blockly.Arduino.addSetup("pwm_setup_" + pwm_channel_b, setupCode_pwm_motor_b, true);
  Blockly.Arduino.addSetup("pwm_attach_" + MotorB_enB, setupCode_pwm_attach_b, true);  
