...
Blockly.Blocks['text_cut_delimiter'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("Initializing and returning first part");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("Cuts a string by a delimiter - returns the FIRST part till delimiter. For further parts use Block \"Cut text - returning next part\"");
...
Blockly.Blocks['text_cut_delimiter_next'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Cut text - returning next part")
