...
Blockly.Arduino['text_compare'] = function(block) {
  ...
  var cmp_string_a = (string_a.indexOf("\"") != 0) || (string_a.indexOf("cut_text") != 0) ? string_a + ".c_str()" : string_a;
  var cmp_string_b = (string_b.indexOf("\"") != 0) || (string_b.indexOf("cut_text") != 0) ? string_b + ".c_str()" : string_b;
