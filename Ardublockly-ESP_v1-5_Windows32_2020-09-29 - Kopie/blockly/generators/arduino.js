...
Blockly.Arduino.init = function(workspace) {
  ...
  // Create a dictionary of code to be printed in the loop() function
...
Blockly.Arduino.finish = function(code) {
  ...
  //Process code from the Blockly.Arduino.addLoop function and add it to the code
  var addLoopCode = '';
  for (var name in Blockly.Arduino.loopCode_) {
    addLoopCode += Blockly.Arduino.loopCode_[name];
  }
 ...
 * @param {!string} codeTag Identifier for the type of code.
 * @param {!string} code Code to be included in the loop() function.
 */
Blockly.Arduino.addLoop = function(codeTag, code) {
    Blockly.Arduino.loopCode_[codeTag] = code;
};
...
Blockly.Arduino.quote_ = function(string) {
  ...
  // Patrick Lamprecht: Deactivated block and inserted only the " replace,
  //    because the block created issues with escaped sequences in strings
...
Blockly.Arduino.scrub_ = function(block, code) {
  ...
  //Define next Block to handle and connect all code fragments to a string and return them
