...
Blockly.Arduino['l298n_setup'] = function(block) {
  ...
  Blockly.Arduino.addSetup('io_' + MotorA_enA, 'pinMode(' + MotorA_enA + ', OUTPUT);', false);
  ...
  Blockly.Arduino.addSetup('io_' + MotorA_in1, 'pinMode(' + MotorA_in1 + ', OUTPUT);', false);
  ...
  Blockly.Arduino.addSetup('io_' + MotorA_in2, 'pinMode(' + MotorA_in2 + ', OUTPUT);', false);
  ...
  Blockly.Arduino.addSetup('io_' + MotorB_in3, 'pinMode(' + MotorB_in3 + ', OUTPUT);', false);
  ...
  Blockly.Arduino.addSetup('io_' + MotorB_in4, 'pinMode(' + MotorB_in4 + ', OUTPUT);', false);
  ...
  Blockly.Arduino.addSetup('io_' + MotorB_enB, 'pinMode(' + MotorB_enB + ', OUTPUT);', false);  
