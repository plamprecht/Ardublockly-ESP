...
Blockly.Arduino['connect_to_wlan'] = function(block) {
	...
	var setupCode_Comm_Prep = "Serial.print('Connecting to WIFI Network: "+ ssid + "');";
...
Blockly.Arduino['start_wifi_access_point'] = function(block) {
  ...
  var statements_while_wifi_connected = Blockly.JavaScript.statementToCode(block, 'while_wifi_connected');
  
  // Communication to Serial Monitor that WiFi will be connected to specified SSID
var Code_Comm_Prep = "Serial.println('\\n');\n  " + "Serial.print('Setting up Access Point "+ ssid + "\n');";
  // Connect WiFi now
  var Code_Connect = "WiFi.softAP("+ssid+", "+key+");\n";
  // Communication to Serial Monitor that WiFi connection is established
  var Code_AP_Est = "IPAddress AP_IP = WiFi.softAPIP();\n" + "Serial.print('AP IP Address: ');\n  " + "Serial.println(AP_IP);";	
  ...
  Blockly.Arduino.addInclude('wifi', '#include <WiFi.h>');
  code = Code_Comm_Prep + Code_Connect + Code_AP_Est;
  return code;
};
